...
import { enUS, uk, ru, zhCN, ar, fr, es, type Locale as DateFnsLocale } from 'date-fns/locale';
...
const LOCALES: Record<string, DateFnsLocale> = { en: enUS, uk, ru, 'zh-CN': zhCN, ar, fr, es };
