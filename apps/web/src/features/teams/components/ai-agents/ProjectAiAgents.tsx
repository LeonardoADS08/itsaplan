...
import { Bot, MessageSquarePlus, Pencil } from 'lucide-react';
...
// The agents working in this project. An agent belongs to the team, so it is attached
// to a project from the team section; here a project member sees which agents write in
// their project and can start a chat with one, and whoever may edit the team's agents
// opens the same sheet the team section uses.
export default function ProjectAiAgents() {
  ...
  return (
    <>
      ...
      <TeamAiAgentSheet open={editing != null} agent={editing} onClose={() => setEditing(null)} />
    </>
  );
}
