...
WITH "created" AS (
  ...
  SELECT t."id", 'Member', true, '{"work_items":{"create":true,"edit":true,"read":true,"delete":true},"initiatives":{"create":true,"edit":true,"read":true,"delete":true},"cycles":{"create":true,"edit":true,"read":true,"delete":true},"dashboards":{"create":false,"edit":false,"read":true,"delete":false},"views":{"create":false,"edit":false,"read":true,"delete":false},"members_invite":{"create":false,"edit":false,"read":true,"delete":false},"members_manage":{"create":false,"edit":false,"read":true,"delete":false},"states":{"create":false,"edit":false,"read":true,"delete":false},"issue_types":{"create":false,"edit":false,"read":true,"delete":false},"labels":{"create":false,"edit":false,"read":true,"delete":false},"ai_agents":{"create":false,"edit":false,"read":true,"delete":false},"integrations":{"create":false,"edit":false,"read":false,"delete":false},"agent_skills":{"create":false,"edit":false,"read":false,"delete":false},"agent_tools":{"create":false,"edit":false,"read":false,"delete":false},"custom_fields":{"create":false,"edit":false,"read":true,"delete":false},"workflow_config":{"create":false,"edit":false,"read":false,"delete":false},"actions":{"create":false,"edit":false,"read":false,"delete":false},"webhooks":{"create":false,"edit":false,"read":false,"delete":false},"note_boards":{"create":true,"edit":true,"read":true,"delete":true},"danger_zone":{"create":false,"edit":false,"read":false,"delete":false}}'::jsonb
    FROM "team" t
